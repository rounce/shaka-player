 ...
 * @private
 */
shaka.net.NetworkingEngine.prototype.onProgress_ =
    function(progressEvent, request) {
  let event = new shaka.util.FakeEvent('progress', {
...
shaka.net.NetworkingEngine.prototype.send_ = function(
  ...
  let sendOperation = backoffOperation.chain(() => {
    ...
    let operation =
      plugin(request.uris[index], request, t.onProgress_.bind(t), type);
